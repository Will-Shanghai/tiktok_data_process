...
def map_sku(name):
    ...
    if ('美容液の大容量版' in name) or ('290g | 美容室専売品' in name): return '头发护理精华'
...
category_mapping = {
    ...
    '头发护理精华': '头发护理精华', '蓝牙MP3': '蓝牙MP3', '车载充电器': '车载充电器', '镁膏': '镁膏'
}
...
common_cost_1 = {
    ...
    '发饰水银13/14点': 16.3, '电动鼻毛刀': 7.8, '头发护理精华': 10, '蓝牙MP3': 43, '车载充电器': 18.4
}

# 本土店物流成本
common_logistics_1 = {
    '黑色睫毛夹': 22.65, '白色睫毛推': 22.45, '电动剃眉刀': 12.5, '车载手机支架': 17.5,
    '发饰水银13/14点': 22.2, '电动鼻毛刀': 14, '头发护理精华': 41, '蓝牙MP3': 24.02, '车载充电器': 23.47
}

# 直邮店物流成本
common_logistics_2 = {
    '黑色睫毛夹': 22.65, '白色睫毛推': 22.45, '电动剃眉刀': 12.5, '车载手机支架': 17.5, '镁膏': 22,
    '发饰水银13/14点': 22.2, '电动鼻毛刀': 25, '头发护理精华': 25, '蓝牙MP3': 24.02, '车载充电器': 23.47
}
