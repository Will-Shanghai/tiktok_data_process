...
def map_sku(name):
    ...
    if '食べ物シリ' in name: return '捏捏乐'
    if ('220 枚') or ('220枚' in name) in name: return '220枚保鲜袋'
    if '超音波式蚊取り器' in name: return '超声波驱蚊器'
...
common_cost_1 = {
    ...
    '蓝牙MP3': 43, '车载充电器': 18.4, '脱毛器': 50, '场景贴纸': 16.8, '220枚保鲜袋': 5.6
}
...
common_logistics_1 = {
    ...
    '蓝牙MP3': 24.02, '车载充电器': 23.47, '场景贴纸': 19, '220枚保鲜袋': 44.6
}
...
sample_cost_2 = {
    ...
    '屏显耳机': 62, '电动剃眉刀': 17.1, '车载手机支架': 22.1, '发饰水银13/14点': 38.5, '电动鼻毛刀': 32.8, '220枚保鲜袋': 49.6
}
