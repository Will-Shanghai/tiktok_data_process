...
DEFAULT_STORES = [
    ...
    },
    {
        ...
        "sheet_name": "日本_直邮店",
        "说明": "日本直邮老店订单 CSV 放 data/data_JP/direct_old",
    },
    {
        "enabled": 1,
        "country_code": "JP",
        ...
        "sheet_name": "日本_直邮店",
        "说明": "日本直邮新店订单 CSV 放 data/data_JP/direct_new",
    },
    {
        "enabled": 1,
        "country_code": "VN",
...
def create_default_app_config():
    ...
    notes_df = pd.DataFrame(
        [
            ...
            ["store_key", "输出文件名使用，例如 Daily_Performance_Report_JP_direct_old.xlsx。"],
            ["store_dir", "订单 CSV 所在目录名，例如 data/data_JP/direct_old。"],
